...
- отправлять напоминание за 30 минут до начала и за 15 минут до конца;
...
- редактировать уроки через кнопку `Редактировать запись`; внутри этого режима есть inline-кнопки `Удалить запись` и `Назад`;
